...
\begin{tabular}{rl}
  ...
  \textbf{Intermediate}: & Scala, Python, Databases (mainly My\textsc{sql} and PostgreSQL)\\
  \textbf{Proficient}:   & Java, JavaScript, Algorithms
\end{tabular}
...
\begin{tabular}{rl}
  ...
  always\\& find new and better ways of solving problems. I was also able to improve this ability\\&
  ...
  class/course representative and even awarded for my leadership abilities.
\end{tabular}
