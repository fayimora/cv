...
\begin{tabular}{rl}
  ...
  \textbf{Proficient}:   & Java, Scala, JavaScript, Algorithms, Web Development, UNIX Systems, Git\\\\
\end{tabular}
...
\begin{tabular}{ll}
  ...
  passion\\& for are Football, Cycling and Tennis. I play football once a week and cycle at least\\&
  fives times a week.\\\\
\end{tabular}
