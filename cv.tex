...
\begin{tabular}{rl}
  \textsc{Feb} 2012 & \textbf{2\textsuperscript{nd}  Prize} and \textbf{Certificate of Outstanding Programming Skill}
  ...
  \textsc{Sept} 2011 & Selected as a \textbf{PASS (Peer Assisted Student Support) mentor} to Computer Science
  students.\\\\

  \textsc{Feb} 2011 & \textbf{1\textsuperscript{st} Prize amongst first years} and \textbf{Certificate of Outstanding Programming
